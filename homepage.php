    ...
    if ($_SESSION['mail']) {
        ...
        <body>
            ...
            <div class="row-homepage">
                ...
                <p class="intro">Primero Avionics is proud to be the youngest domestic Pakistani airline to serve all the areas
                    of Pakistan, and thanks to our customers’ response to our offerings, we are also Pakistan's fastest-growing
                    airline. We connect multiple destinations on the map every day, with a fleet of the latest-generation
                    aircraft, and an unrivalled level of service.
                    As aviation faces its greatest challenge, we remain committed to ensuring the highest standards of safety
                    and hygiene on board our aircraft at all times. Primero Avionics is one of the few airlines in the world to
                    achieve the prestigious 5-Star COVID-19 Airline Safety Rating by air transport rating organisation, Skytrax.
                    These recognitions provides assurance to passengers across the world that airline health and safety
                    standards are subject to the highest possible standards of professional, independent scrutiny and
                    assessment.

                    Since our launch in 1997, Primero Avionics has earned many awards and accolades, becoming one of an elite
                    group of airlines worldwide to have earned a 5-star rating by Skytrax. Voted Airline of the Year by Skytrax
                    in 2011, 2012, 2015, 2017 and most recently in 2019, Primero Avionics has won the confidence of the
                    travelling public. We have accomplished these goals by focusing on the details – how we run the business,
                    and how you experience our airline.

                    Our goal is to make Primero Avionics your airline of choice, offering the flights you want to the
                    destinations you need. It is this which drives our collective mission to achieve ‘Excellence in everything
                    we do’ at all levels across our Primero Avionics family of highly-skilled and committed professionals.

                    On behalf of everyone at Primero Avionics, we look forward to welcoming you on board, and let us Go Places
                    Together.
                    Thank you.
                    ...
                    <div class="col">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Come visit the breathtaking natural beauty of the capital of Pakistan, with
                                    green-blanketed rolling Margalla Hills, multi colored trees, chirping birds and fragrant
                                    atmosphere in the enthralling beauties of August.</p>
                            </div>
                            <div class="btn-book">
                    ...
                    <div class="col">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">The largest city of Pakistan is waiting for you as the iconic and beautiful
                                    tomb of Quaid-e-Azam is surely not to miss in these enthralling beauties of August.</p>
                            </div>
                            <div class="btn-book">
                    ...
                    <div class="col">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Skardu: An embodiment of nature's perfection offers you a scenic valley
                                    with blue water and high mountains as a major tourism, trekking and expedition hub in
                                    Gilgit–Baltistan</p>
                            </div>
                            <div class="btn-book">
                    ...
                    <div class="col">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Enjoy some days in the Heart of Pakistan, Lahore, with great food,
                                    never-ending entertainment, shopping, greenery and winters.</p>
                            </div>
                            <div class="btn-book">
